#!/usr/bin/env bash
#
# grade.sh - local grader for Assignment 2 (Dockerized Diagnostic CLI)
#
# Checks required files, Dockerfile/.dockerignore/compose sanity, builds the
# image, and runs functional + student test.sh checks against it.
